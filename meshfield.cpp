...
// マクロ定義
//*****************************************************************************
#define	TEXTURE_FILENAME	"data/TEXTURE/field000.png"		// 読み込むテクスチャファイル名
...
// プロトタイプ宣言
//*****************************************************************************
HRESULT MakeMeshField(D3DXVECTOR3 pos, D3DXVECTOR3 rot, int nNumBlockX, int nNumBlockZ, float fBlockSizeX, float fBlockSizeZ);
...
{
	MakeMeshField(D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), 50, 50, 80.0f, 80.0f);
...
// Meshfield作成処理
//=============================================================================
HRESULT MakeMeshField(D3DXVECTOR3 pos, D3DXVECTOR3 rot,
