...
// マクロ定義
//*****************************************************************************
#define	MAX_MESH_WALL		(100)							// 壁の総数
#define	TEXTURE_FILENAME	"data/TEXTURE/wall000.png"		// 読み込むテクスチャファイル名
...
HRESULT InitMeshWall(void)
{
	...
	MakeMeshWall(D3DXVECTOR3(0.0f, 0.0f, 2000.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f),
		D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f), 10, 1, 400.0f, 400.0f);
	MakeMeshWall(D3DXVECTOR3(-2000.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, -D3DX_PI * 0.50f, 0.0f),
		D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f), 10, 1, 400.0f, 400.0f);
	MakeMeshWall(D3DXVECTOR3(2000.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, D3DX_PI * 0.50f, 0.0f),
		D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f), 10, 1, 400.0f, 400.0f);
	MakeMeshWall(D3DXVECTOR3(0.0f, 0.0f, -2000.0f), D3DXVECTOR3(0.0f, D3DX_PI, 0.0f),
		D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f), 10, 1, 400.0f, 400.0f);

	// 壁(裏側用)
	MakeMeshWall(D3DXVECTOR3(0.0f, 0.0f, 2000.0f), D3DXVECTOR3(0.0f, D3DX_PI, 0.0f),
		D3DXCOLOR(1.0f, 1.0f, 1.0f, 0.25f), 10, 1, 400.0f, 400.0f);
	MakeMeshWall(D3DXVECTOR3(-2000.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, D3DX_PI * 0.50f, 0.0f),
		D3DXCOLOR(1.0f, 1.0f, 1.0f, 0.25f), 10, 1, 400.0f, 400.0f);
	MakeMeshWall(D3DXVECTOR3(2000.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, -D3DX_PI * 0.50f, 0.0f),
		D3DXCOLOR(1.0f, 1.0f, 1.0f, 0.25f), 10, 1, 400.0f, 400.0f);
